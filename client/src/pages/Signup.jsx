                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="block w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50/50 text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-orange/20 focus:border-orange transition-all duration-200 text-sm text-center tracking-widest text-xl"
                                                placeholder="######"
                                                required
                                                maxLength={6}
                                            />
